          ...
          {paymentResult === 'success' ? (
            <>
              ...
              <p className="text-ink-faint text-sm mb-6">
                Your registration for <span className="text-brand font-semibold">Create Softwares Without Writing A Single Line Of Code</span> has been confirmed.
              </p>
              <div className="rounded-lg bg-gray-50 border border-gray-200 p-4 text-left text-xs text-ink-faint space-y-1 mb-6">
                ...
                <p><span className="text-ink-muted">Amount Paid:</span> <span className="text-brand font-semibold">{COURSE_FEE_STR} (+ PayU charges)</span></p>
              </div>
              ...
              <a href="https://chat.whatsapp.com/KqjIjm2YhlkJNKZR6ObCoE" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-lg bg-[#25D366] text-white font-semibold text-sm shadow hover:bg-[#20bd5a] transition">
    ...
    switch (step) {
      case 0: return (
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-[12px] text-ink-muted mt-1">Confirmation details & session links will be sent here.</p>
      ...
      case 1: return (
        <div className="space-y-4">
          ...
          <p className="text-xs text-ink-muted mb-4">Your background helps us tailor the workshop pace.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
          ...
          <div>
            ...
            <p className="text-[12px] text-ink-muted mt-1">College name if student, company/startup if working</p>
      ...
      case 2: return (
        <div className="space-y-4">
          ...
          <p className="text-xs text-ink-muted mb-4">No coding experience is required for this workshop!</p>
          <div>
    ...
    <div className="min-h-screen bg-paper px-4 py-8 sm:py-12">
      <div className="w-full max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-paper-alt border border-line text-brand text-xs font-semibold mb-3">
          ...
          <p className="text-ink-faint text-sm mt-2 max-w-xl mx-auto font-medium">
            Learn to build full apps &amp; website UIs visually using <strong className="text-brand font-bold">Blue AI</strong>.
          </p>
        </div>

        {/* Demo Video Section */}
        <div className="rounded-lg bg-slate-900 border border-slate-800 p-2 sm:p-3 mb-8 overflow-hidden">
          <div className="flex items-center justify-between px-3 py-1.5 bg-slate-800/80 rounded-t-xl mb-2">
            ...
            <span className="text-[11px] font-semibold text-brand bg-brand/10 px-2.5 py-0.5 rounded-full border border-brand/30">
        ...
        <div className="rounded-lg bg-white border border-gray-200 p-6 shadow-sm mb-8 space-y-6">
          {/* Pricing Banner */}
          <div className="rounded-lg bg-brand border border-line p-4 sm:p-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-brand">Course Fee Breakdown</span>
                <div className="text-2xl font-extrabold text-gray-900">
                  {COURSE_FEE_STR} <span className="text-xs font-normal text-ink-faint">/ seat</span>
                </div>
              ...
              <div>
                <span className="inline-block px-3 py-1.5 rounded-full bg-brand text-white font-bold text-xs shadow-sm">
                  <i className="fa-solid fa-calendar-week mr-1"></i> 1-Week Live Course
                </span>
              </div>
            </div>
            <p className="text-[11px] text-ink-faint mt-2.5 pt-2 border-t border-line">
              <i className="fa-solid fa-circle-info mr-1 text-brand"></i> Includes standard PayU payment gateway &amp; processing charges. Net course fee retained: &#8377;1,000.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="rounded-lg bg-gray-50 border border-gray-200 p-3.5 flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-paper-alt text-brand flex items-center justify-center shrink-0 font-bold text-xs">
          ...
          {/* Quick Summary Strip */}
          <div className="rounded-lg bg-slate-50 border border-slate-200 p-3.5 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        <p className="text-center text-[10px] text-ink-muted mt-4">
          Secured by <span className="text-ink-faint font-semibold">PayU Payments</span>. Data encrypted.
        </p>
      </div>
    </div>
  );
