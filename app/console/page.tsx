              ...
              {modalConfig.type === 'confirm' ? (
                <>
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-lg bg-brand text-sm font-semibold text-white shadow-lg active:scale-[0.98] transition duration-200"
                  >
                    Confirm
                  </button>
                </>
                ...
                <button
                  ...
                  className="px-6 py-2 rounded-lg bg-brand text-sm font-semibold text-white shadow-lg active:scale-[0.98] transition duration-200"
                >
                  OK
                </button>
              )}
