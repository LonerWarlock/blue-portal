...
const inputClass = 'w-full px-4 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-800 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition placeholder:text-gray-400';
          ...
          {paymentResult === 'success' ? (
            <>
              ...
              <div className="rounded-xl bg-gray-50 border border-gray-200 p-4 text-left text-xs text-gray-500 space-y-1 mb-6">
                {resultData && (
                  <>
                    <p><span className="text-gray-400">Team:</span> <span className="text-gray-700 font-medium">{resultData.teamName}</span></p>
                    <p><span className="text-gray-400">Leader:</span> <span className="text-gray-700">{resultData.leaderName}</span></p>
                    <p><span className="text-gray-400">Email:</span> <span className="text-gray-700">{resultData.email}</span></p>
                  </>
                )}
                <p><span className="text-gray-400">Amount Paid:</span> <span className="text-green-500 font-semibold">{HACKATHON_FEE_STR}</span></p>
              </div>
              <a href="/hackathon" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-400 to-green-400 font-semibold text-white text-sm shadow hover:from-blue-500 hover:to-green-500 transition">
            ...
            <>
              ...
              <div className="flex gap-3 justify-center">
                <button onClick={() => { setStep(2); setForm(f => ({ ...f, declarationAccepted: false, termsAccepted: false })); window.history.replaceState({}, '', '/hackathon'); }}
                  className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-400 to-green-400 font-semibold text-white text-sm shadow hover:from-blue-500 hover:to-green-500 transition">
                  Try Again
                </button>
    ...
    switch (step) {
      case 0: return (
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-400 mb-4">Tell us about the team leader.</p>
      ...
      case 1: return (
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-400 mb-4">Add your team name and member details.</p>
          ...
          <div className="rounded-xl bg-blue-50 border border-blue-100 p-4 text-xs text-blue-600">
          ...
          <div className="space-y-3">
            <label className="flex items-start gap-3 cursor-pointer select-none group">
              <input type="checkbox" checked={form.declarationAccepted} onChange={e => set('declarationAccepted', e.target.checked)}
                className="w-4 h-4 mt-0.5 rounded border-gray-300 bg-white text-blue-500 focus:ring-blue-100 shrink-0" />
    ...
    <div className="min-h-screen bg-[#f8fafb] px-4 py-10">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-600 text-xs font-semibold mb-4">
            <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse"></span>
            Register for Hackathon
          </div>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-800">
            <span className="bg-gradient-to-r from-blue-500 via-green-400 to-yellow-400 bg-clip-text text-transparent">IGNITE PVPIT 2026</span>
          </h1>
          <p className="text-gray-500 text-sm mt-2">48-Hour Online Hackathon &mdash; Build Solutions for Real-Life Problems</p>
        </div>
        ...
        <div className="rounded-2xl bg-white border border-gray-200 p-6 sm:p-8 shadow-sm mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
            ...
            <div className="rounded-xl bg-purple-50 border border-purple-100 p-4">
              ...
              <ul className="text-xs text-gray-600 space-y-1.5">
                ...
                <li><span className="text-gray-400 font-bold">2nd Place</span> &mdash; ₹1,000</li>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 rounded-xl bg-white border border-gray-200 p-4">
              <h3 className="text-sm font-bold text-gray-700 mb-2 flex items-center gap-1.5">
                <i className="fa-solid fa-link text-xs text-blue-500"></i> Links
              </h3>
              <ul className="text-xs text-gray-600 space-y-1.5">
                <li>
                  <a href="https://chat.whatsapp.com/HHRjpE4pPH61nwDVTvDw2B" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">
                    Join the WhatsApp Group
                  </a>
                </li>
                <li>
                  <a href="https://www.imergene.in" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">
            ...
            <div key={s} className="flex items-center flex-1">
              <div className="flex flex-col items-center flex-1">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0 transition-all duration-300 ${
                  ...
                  : i === step ? 'bg-blue-100 border border-blue-300 text-blue-600 shadow-lg shadow-blue-100'
        ...
        <div className="rounded-2xl bg-white border border-gray-200 p-6 sm:p-8 shadow-lg">
          ...
          <div className="flex items-center justify-between mt-6 pt-5 border-t border-gray-100">
            ...
            {step < 2 ? (
              <button onClick={nextStep} className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-400 to-green-400 font-semibold text-white text-sm shadow hover:from-blue-500 hover:to-green-500 transition flex items-center gap-2">
                Next <i className="fa-solid fa-arrow-right text-xs"></i>
              </button>
            ) : (
              <button onClick={handlePayment} disabled={loading}
                className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-400 to-green-400 font-semibold text-white text-sm shadow hover:from-blue-500 hover:to-green-500 transition flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                {loading ? (
                  <>
