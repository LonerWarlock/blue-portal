...
export default function VSCodeInstallSnippet({ className = '' }: { className?: string }) {
  ...
  return (
    <div className={`w-full max-w-xl mx-auto ${className}`}>
      ...
      <div className="group relative flex items-center justify-between gap-3 bg-paper border border-line hover:border-line-strong rounded-md px-4 py-2.5 transition-colors duration-150">
